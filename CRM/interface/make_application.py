...
class UiMakeApplication(object):
...
"")
        ...
        self.color_text = QtWidgets.QLineEdit(MakeApplication)
        self.color_text.setGeometry(QtCore.QRect(262, 138, 151, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.color_text.setFont(font)
        self.color_text.setStyleSheet("background:rgb(255, 255, 255)")
        self.color_text.setObjectName("color_combobox")
        self.type_text = QtWidgets.QLineEdit(MakeApplication)
        self.type_text.setGeometry(QtCore.QRect(262, 88, 151, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.type_text.setFont(font)
        self.type_text.setStyleSheet("background:rgb(255, 255, 255)")
        self.type_text.setObjectName("type_combobox")
