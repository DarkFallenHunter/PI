...
class UiAuthorizationWindow(object):
    def setupUi(self, authorization_window):
        ...
        self.login_label.setGeometry(QtCore.QRect(90, 100, 61, 16))
        font = QtGui.QFont()
        ...
        self.password_label.setGeometry(QtCore.QRect(73, 140, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.authorization_label = QtWidgets.QLabel(self.centralwidget)
        self.authorization_label.setGeometry(QtCore.QRect(50, 40, 381, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.authorization_label.setStyleSheet("color: rgb(255, 255, 255);")
        self.authorization_label.setObjectName("label_3")
...
"")
    ...
    def retranslateUi(self, authorization_window):
        ...
        self.authorization_label.setText(_translate("authorization_window", "Авторизируйтесь в системе"))
