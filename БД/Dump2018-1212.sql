...
INSERT INTO `3d_model` VALUES (1,'dragon.stl','C:\\screen1.jpg'),(2,'tower.stl','C:\\screen2.jpg'),(3,'bird.stl','C:\\screen3.jpg'),(4,'podshipnic.stl','C:\\screen4.jpg'),(5,'death_star.stl','C:\\screen5.jpg');
...
CREATE TABLE `delivery` (
  ...
  CONSTRAINT `DeliveryStatuses_DeliveryFK` FOREIGN KEY (`status`) REFERENCES `delivery_statuses` (`status_id`),
  ...
  CONSTRAINT `InfoAboutMaterial_DeliveryFK` FOREIGN KEY (`material_id`) REFERENCES `information_about_material` (`material_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `delivery` VALUES (4,1,7,200,4,'2018-09-10','2018-09-12','C:\\dog1.doc'),(4,2,8,200,4,'2018-09-10','2018-09-12','C:\\dog2.doc'),(4,3,9,200,4,'2018-09-10','2018-09-12','C:\\dog3.doc'),(4,4,10,200,3,'2018-12-03','2018-12-08','C:\\dog4.docx'),(4,5,11,200,4,'2018-09-10','2018-09-12','C:\\dog5.doc'),(4,6,12,200,4,'2018-09-10','2018-09-12','C:\\dog6.doc'),(4,7,13,100,4,'2018-09-10','2018-09-12','C:\\dog7.doc');
...
INSERT INTO `delivery_statuses` VALUES (1,'Ожидание ответа со стороны поставщика'),(2,'Сборка товара для доставки'),(3,'Доставка в пути'),(4,'Доставка получена');
...
INSERT INTO `information_about_material` VALUES (7,'Синий','PVA пластик',12,'https://photogora.ru/img/product/thumb/4615/1473685090161644615.jpg'),(8,'Оранжевый','Нейлон',10,'https://photogora.ru/img/product/big/3678/1473684899456743678.jpg'),(9,'Красный','PLA пластик',3,'https://photogora.ru/img/product/big/6053/14780170410.jpg'),(10,'Зелёный','ABS пластик',2,'https://photogora.ru/img/product/th/3502/1473674175814253502.jpg'),(11,'Оранжевый','Нейлон',3,'https://photogora.ru/img/product/big/3678/1473684899456743678.jpg'),(12,'Чёрный','PLA пластик',5,'https://photogora.ru/img/product/th/4782/147368516884874782.jpg'),(13,'Белый','PVA пластик',5,'https://photogora.ru/img/product/big/3394/14811066250.jpg');
...
INSERT INTO `order` VALUES (7,1,500.00,1,1,'Синий дракон','2018-09-12',1),(7,2,1000.00,2,2,'Мини-копия останкинской башни красного цвета','2018-09-12',2),(5,3,1000.00,3,3,'Зелёная птица','2018-12-03',3),(3,4,1200.00,3,4,'Подшипник оранжевый','2018-12-03',4),(5,5,1100.00,4,5,'Мини-копия звезды смерти','2018-12-03',5);
...
INSERT INTO `order_end_dates` VALUES (1,'2018-12-15'),(2,'2018-12-10'),(3,'2018-12-10'),(4,'2018-12-20'),(5,'2018-12-15');
...
CREATE TABLE `request` (
  ...
  CONSTRAINT `RequestStatues_RequestFK` FOREIGN KEY (`status`) REFERENCES `request_statuses` (`status_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `request` VALUES (1,'2018-09-12','2018-09-12',1,7,50,4),(2,'2018-09-12','2018-09-12',2,9,90,4),(3,'2018-12-03','2018-12-08',3,10,90,3),(4,'2018-12-03','2018-12-03',4,8,90,4),(5,'2018-12-03','2018-12-03',5,12,90,4);
...
INSERT INTO `request_statuses` VALUES (1,'Ожидание ответа со стороны снабженца'),(2,'Заявка принята'),(3,'Сборка необходимых материалов'),(4,'Заявка выполнена');
...
-- Dump completed on 2018-12-12 21:39:00
