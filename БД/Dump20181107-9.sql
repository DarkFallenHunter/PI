...
INSERT INTO `material` VALUES ('ABS пластик','Зеленый',1),('PLA пластик','Красный',2);
...
INSERT INTO `order` VALUES (6,1,1000.00,1,1,'Клиенту номер один нужен 1 зеленый кролик','2018-10-24','2018-10-30'),(6,3,529.00,1,2,'Клиенту 1 нужен серый еж','2018-10-24','2018-10-30'),(3,4,1050.00,2,3,'Клиенту 2 нужен зеленый пингвин','2018-11-04','1018-11-13'),(5,5,1000.00,1,1,'Повтор заказа 1','2018-11-05','2018-11-11');
...
INSERT INTO `order_employee` VALUES (1,1),(3,1),(1,2),(3,3);
...
INSERT INTO `order_material` VALUES (1,1),(3,1);
...
-- Dump completed on 2018-11-07 21:46:57
