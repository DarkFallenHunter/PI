...
CREATE TABLE `delivery` (
  ...
  `diameter_of_the_strand` varchar(45) NOT NULL,
...
INSERT INTO `information_about_material` VALUES (7,'Синий','PVA пластик',12),(8,'Оранжевый','Нейлон',10),(9,'Красный','PLA пластик',3),(10,'Зелёный','ABS пластик',2),(11,'Оранжевый','Нейлон',3),(12,'Чёрный','PLA пластик',5),(13,'Белый','PVA пластик',5);
...
-- Dump completed on 2018-12-05  0:37:46
