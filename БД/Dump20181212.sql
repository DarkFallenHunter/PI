...
CREATE TABLE `delivery` (
  ...
  CONSTRAINT `DeliveryStatuses_DeliveryFK` FOREIGN KEY (`status`) REFERENCES `delivery_statuses` (`statuses_id`),
...
INSERT INTO `delivery` VALUES (4,1,7,200,4,'2018-09-10','2018-09-12'),(4,2,8,200,4,'2018-09-10','2018-09-12'),(4,3,9,200,4,'2018-09-10','2018-09-12'),(4,4,10,200,3,'2018-12-03','2018-12-08'),(4,5,11,200,4,'2018-09-10','2018-09-12'),(4,6,12,200,4,'2018-09-10','2018-09-12'),(4,7,13,100,4,'2018-09-10','2018-09-12');
...
CREATE TABLE `delivery_statuses` (
  `statuses_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `request_statuses` VALUES (1,'Ожидание ответа со стороны поставщика'),(2,'Заявка принята'),(3,'Сборка необходимых материалов'),(4,'Заявка выполнена');
...
-- Dump completed on 2018-12-12 11:00:58
