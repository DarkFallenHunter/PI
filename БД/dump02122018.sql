...
CREATE TABLE `amount_of_material` (
  ...
  CONSTRAINT `amount_of_material_ibfk_1` FOREIGN KEY (`material_id`) REFERENCES `information_about_material` (`material_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order` (
  ...
  KEY `Material_OrderFK_idx` (`material_id`),
  CONSTRAINT `Client_OrderFK` FOREIGN KEY (`client_id`) REFERENCES `client` (`client_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Materil_OrderFK` FOREIGN KEY (`material_id`) REFERENCES `material` (`material_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `order` VALUES (5,1,1000.00,1,1,'Клиенту 1 нужен зеленый кролик','2018-10-24','2018-10-30',9),(7,3,529.00,1,2,'Клиенту 1 нужен красный ежик','2018-10-24','2018-10-30',10),(3,4,1050.00,2,3,'Клиенту 2 нужен зеленый пингвин ','2018-11-04','1018-11-13',9),(2,5,1000.00,1,1,'Повтор заказа 1 ','2018-11-05','2018-11-11',10);
...
INSERT INTO `order_employee` VALUES (1,1),(4,1),(5,1),(4,2),(5,3);
...
CREATE TABLE `order_material` (
  ...
  CONSTRAINT `order_material_ibfk_1` FOREIGN KEY (`order_number`) REFERENCES `order` (`order_number`),
...
INSERT INTO `order_modification` VALUES (1,'Доработать');
...
CREATE TABLE `request` (
  ...
  KEY `Material_RequestFK_idx` (`material_id`),
  CONSTRAINT `Material_RequestFK` FOREIGN KEY (`material_id`) REFERENCES `information_about_material` (`material_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `request` VALUES (11,'2018-11-05','2018-11-12',4,9,111),(22,'2018-11-06','2018-11-10',5,10,222),(33,'2018-11-06','2018-11-10',1,8,333);
...
INSERT INTO `request_employee` VALUES (2,11),(3,22),(2,33),(3,33);
...
CREATE TABLE `request_material` (
  ...
  CONSTRAINT `request_material_ibfk_1` FOREIGN KEY (`material_id`) REFERENCES `amount_of_material` (`material_id`),
  CONSTRAINT `request_material_ibfk_2` FOREIGN KEY (`request_number`) REFERENCES `request` (`request_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `store_material` VALUES (7,383),(8,716),(9,200),(10,633);
...
-- Dump completed on 2018-12-02 21:59:36
