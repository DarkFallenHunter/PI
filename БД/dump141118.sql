...
INSERT INTO `3d_model` VALUES (1,'somewhere.txt'),(2,'neverwhere.doc'),(3,'extra.txt'),(4,'somewhere.txt'),(5,'C:/Users/Hunte/Desktop/Ашан Гагаринский 08.11.2018/IMG_0982.JPG'),(6,'C:/Users/Hunte/Desktop/Ашан Гагаринский 08.11.2018/IMG_0977.JPG'),(7,'C:/Users/Hunte/Desktop/Ашан Гагаринский 08.11.2018/IMG_0980.JPG'),(8,'C:/Users/Hunte/Desktop/Ашан Гагаринский 08.11.2018/IMG_0998.JPG'),(9,'C:/Users/Hunte/Desktop/Ашан Гагаринский 08.11.2018/IMG_1055.JPG');
...
INSERT INTO `amount_of_material` VALUES (7,111),(8,222);
...
INSERT INTO `client` VALUES ('Борзых','Никита','Юрьевич','+7-999-888-32-32','allyru@gmail.com',1),('Крилл','Кирилл','Кирильевич','+7-000-111-22-33','shadyguy@mail.ru',2),('Зайцев','Василий','Иванович','+7-916-956-76-19','zaicev@mail.ru',3);
...
INSERT INTO `information_about_material` VALUES (7,'Синий','PVA пластик',17),(8,'Оранжевый','Нейлон',18),(9,'Красный','Нейлон',3),(10,'Зелёный','ABS пластик',2);
...
INSERT INTO `material` VALUES ('ABS пластик','Зеленый',1),('PLA пластик','Красный',2),('Нейлон','Оранжевый',3),('ABS пластик','Зелёный',4),('Нейлон','Красный',5),('PVA пластик','Синий',6),('Нейлон','Красный',7);
...
INSERT INTO `order` VALUES (6,1,1000.00,1,1,'Клиенту номер один нужен 1 зеленый кролик','2018-10-24','2018-10-30'),(6,3,529.00,1,2,'Клиенту 1 нужен серый еж','2018-10-24','2018-10-30'),(3,4,1050.00,2,3,'Клиенту 2 нужен зеленый пингвин','2018-11-04','1018-11-13'),(5,5,1000.00,1,1,'Повтор заказа 1','2018-11-05','2018-11-11'),(2,6,0.00,2,5,'Создать модель оранжевой кегли','2018-11-09','0000-00-00'),(4,7,0.00,1,6,'Распечатать зелёное ведёрко','2018-11-09','0000-00-00'),(4,8,0.00,1,7,'Напечатать красный совок','2018-11-09','0000-00-00'),(2,9,0.00,3,8,'Напечатать модель синей пирамидки','2018-11-09','0000-00-00'),(4,10,0.00,3,9,'Создать модель зелёной ванночки','2018-11-09','0000-00-00');
...
INSERT INTO `order_employee` VALUES (1,1),(3,1),(6,1),(7,1),(8,1),(9,1),(10,1),(1,2),(6,2),(8,2),(10,2),(3,3),(7,3),(9,3);
...
INSERT INTO `order_material` VALUES (1,1),(3,1),(6,3),(7,4),(8,5),(9,6),(10,7);
...
INSERT INTO `order_modification` VALUES (1,'Добавить уши зеленому кролику'),(7,'Не заданы размеры'),(8,'Не указаны размеры'),(10,'Не указаны необходимые размеры.');
...
CREATE TABLE `rejected_orders` (
  ...
  `employee_id` int(11) NOT NULL,
  PRIMARY KEY (`order_number`),
  CONSTRAINT `Orders_RegectedOrdersFK` FOREIGN KEY (`order_number`) REFERENCES `order` (`order_number`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `request` VALUES (11,'2018-09-09','2018-10-31',1),(22,'2018-09-09','2018-10-29',2);
...
INSERT INTO `request_employee` VALUES (4,11),(4,22);
...
INSERT INTO `request_material` VALUES (7,11),(8,22);
...
INSERT INTO `statuses` VALUES (1,'Ожидание ответа работника'),(2,'Заказ принят работником'),(3,'Ожидание материалов'),(4,'Модификация заказа'),(5,'Создание продукта'),(6,'Продукт изготовлен');
...
INSERT INTO `store_material` VALUES (7,77),(8,88);
...
-- Dump completed on 2018-11-14  9:27:09
